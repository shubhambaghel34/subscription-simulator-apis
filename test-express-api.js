...
async function testExpressAPI() {
  console.log('🧪 Testing Express.js Recurring Donations API...\n');
  ...
  try {
    ...
    const subscription = createResponse.data.data;
    ...
    console.log('✅ Subscription Stats:', statsResponse.data.data);
    console.log('');
    ...
    console.log('✅ Transaction Stats:', transactionStatsResponse.data.data);
    console.log('');
